...
async def handle_client(websocket):
    ...
    try:
        ...
        async for message in websocket:
            # Broadcast the message to all connected clients, build a list of stacks and each stack sends the message to a different connected client (asyncio.wait to run them all at the same time)
